...
import favicon from '../../../static/star.png'
                ...
                <div className="viewport-top">
                    ...
                    {isHome ? (
                        <header
                            ...
                            style={{
                                ...(site.cover_image && {
                                    background: `linear-gradient(rgba(255,255,255, 0.75), rgba(0,0,0,0.05)), url(${site.cover_image}) no-repeat`,
                                    height: `80vh`,
                                    overflow: `hidden`,
                                    display: `flex`,
                                    alignItems: `center`,
                    ...
                    <main className={isHome ? 'site-main' : null}>
